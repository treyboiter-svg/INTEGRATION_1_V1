...
for %%F in (build_dashboard_bundle_V44.py mlb-pitch-environment-live-dashboard-V44.html V44_IN_APP_GLOSSARY.json) do (
...
if not defined RUN ( echo No run directory found. Run RUN_DAILY_MLB_DASHBOARD_V44.bat first. & pause & exit /b 1 )
